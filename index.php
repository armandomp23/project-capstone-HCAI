...
<head>
	<title>1st Bookstore for Weeboo</title>
	<meta charset="utf-8">
					...
					<div class="row">
						<div class="col">
							<div class="header_content d-flex flex-row align-items-center justify-content-start">
								<div class="logo"><a href="index.php">AruMedia</a></div>
								<nav class="main_nav">
									<ul>
									...
									<div class="col">
										<div class="home_slider_content" data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
											<div class="home_slider_title">
												<font size="5px">Toko Buku Terlaris Di Batam</font>
											</div>
											<div class="home_slider_subtitle">Selamat Datang di AruMedia</div>
				...
				<div class="row icon_box_row">
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							...
							<div class="icon_box_title">Gratis Ongkir Se-Batam</div>
							<div class="icon_box_text">
								<p>Gratis Ongkir Pulau Batam Non Minimum Selama Periode Desember 2022.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							...
							<div class="icon_box_text">
								<p>Khawatir buku tidak cocok? Jangan khawatir, karena apapun alasannya retur di AruMedia gratis & mudah!</p>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col">
						<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
							<div class="footer_logo"><a href="index.php">AruMedia</a></div>
							<div class="copyright ml-auto mr-auto">
								<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
								Copyright &copy;<script>
									document.write(new Date().getFullYear());
								</script> All rights reserved | AruMedia <br>
...
<script>
  window.watsonAssistantChatOptions = {
    integrationID: "f2627536-edbd-4bfd-b991-14b4a2c92d3b", // The ID of this integration.
    region: "au-syd", // The region your integration is hosted in.
    serviceInstanceID: "70e5d41f-4045-419e-b0b8-d320bafdd7c3", // The ID of your service instance.
