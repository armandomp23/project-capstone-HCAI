    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../../../dashboard.php">AruMedia</a>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="table_penerbit.php">Data Penerbit</a>
                                        </li>
                                        <li class="nav-item">
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Penerbit</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Tables</a></li>
                                            <li class="breadcrumb-item"><a href="table_penerbit.php" class="breadcrumb-link">Data
                                                    Penerbit</a></li>
                                            <li class="breadcrumb-item active" aria-current="page"></li>Form Penerbit
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="process/edit_penerbit.php" method="POST">
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">ID Penerbit</label>
                                        <div class="col-md-9">
                                            <input type="text" name="id_penerbit" class="form-control" value="<?php echo $id_penerbit ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="nama_penerbit" class="form-control" placeholder="Nama Penerbit"
                                                value="<?php echo $item['nama_penerbit'] ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="alamat_penerbit" id="" cols="30" rows="10" class="form-control"
                                                placeholder="Alamat Penerbit" required><?php echo $item['alamat_penerbit'] ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="email" name="email_penerbit" class="form-control" placeholder="Email Penerbit"
                                                value="<?php echo $item['email_penerbit'] ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" name="telp_penerbit" class="form-control" placeholder="Nomor Telepon"
                                                value="<?php echo $item['telp_penerbit'] ?>" required>
                                        </div>
                                    </div>
            ...
            <div class="footer">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        Copyright © 2022 AruMedia. All rights reserved.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        </div>
                    </div>
