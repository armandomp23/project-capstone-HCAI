                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="table_penerbit.php">Data Penerbit</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <div class="card-body">
                                <form action="process/edit_customer.php" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="id_customer" class="form-control" value="<?php echo $id_customer ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="alamat_customer" id="" cols="30" rows="10" class="form-control"
                                                placeholder="Alamat Customer" required><?php echo $item['alamat_customer'] ?></textarea>
                                        </div>
                                    </div>
