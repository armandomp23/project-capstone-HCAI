                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="process/add_pengarang.php" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="id_pengarang" class="form-control" value="PG-<?php echo $no+$jumlah ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="alamat_pengarang" id="" cols="30" rows="10" class="form-control"
                                                placeholder="Alamat Pengarang" required></textarea>
                                        </div>
                                    </div>
