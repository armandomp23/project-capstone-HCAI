                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="form_penerbit.php" class="btn btn-primary">Tambah Data</a>
                                <?php
                                $message = '';
                                if(isset($_GET["error"]))
                                {
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = 
                                            "SELECT * FROM penerbit WHERE deleted = 0";
                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>" . $row["telp_penerbit"] . "</td>
                                                        <td>
                                                            <a href='form_edit_penerbit.php?id_penerbit=$id_penerbit' class='btn btn-warning'>Update</a>
                                                            <a href='process/delete_penerbit.php?id_penerbit=$id_penerbit' class='btn btn-danger'>Delete</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
